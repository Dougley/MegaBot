...
module.exports = {
  ...
  fn: async (msg, suffix) => {
    ...
    try {
      ...
      if (dupes.some(x => x.authorId === msg.author.id)) return msg.edit('One or more of your dupes have been submitted by you, please double check the IDs and try again.')
      await message.edit({
