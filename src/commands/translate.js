...
module.exports = {
  ...
  fn: async (msg, suffix) => {
    try {
      ...
      if (e.message === 'Not Found') return msg.channel.createMessage('This post is either being held for review or has been removed.')
      else msg.channel.createMessage(MB_CONSTANTS.generateErrorMessage(e))
    }
  }
}
