const templates = [
  ...
  '{s} tried to modify the Blastoise Dupe Bomber 3000 to take down {r} with tons of dupe reports, but Dannysaur got there first and denied them all... Which broke the machine.'
]
